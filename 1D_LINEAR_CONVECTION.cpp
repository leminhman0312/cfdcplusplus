...
int main(){
	...
	engEvalString(ep,"h = plot(X_matlab,U_matlab);");
	...
	engEvalString(ep,"saveas(h,'1D_LINEAR_CONVECTION.png')");
	...
	*/ 
	...
	engEvalString(ep,"v = VideoWriter('1D_LINEAR_CONVECTION.avi');");
